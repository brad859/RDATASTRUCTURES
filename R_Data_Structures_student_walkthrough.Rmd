...
# Create a dataframe from these three vectors, each vector is in its own column.
...
my_matrix <- matrix(
  ...
  ncol <- 5,
  byrow <- FALSE,
  dinames <- list(c("Row 1","Row 2"), c("Col 1","Col 2", "Col 3","Col 4","Col 5"))
)
